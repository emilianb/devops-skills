...
namespace Benday.Presidents.IntegrationTests
{
    ...
    public class SqlEntityFrameworkPersonRepositoryFixture
    {
        ...
        public void SqlEntityFrameworkPersonRepository_SavePerson_RemoveExistingFact()
        {
            ...
            actual.AddFact(22, PresidentsConstants.President, new DateTime(2001, 1, 1), new DateTime(2005, 1, 1));
            actual.AddFact(24, PresidentsConstants.President, new DateTime(2007, 1, 1), new DateTime(2010, 1, 1));
